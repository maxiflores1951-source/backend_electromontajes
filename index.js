...
const propietariosRoutes = require('./src/routes/propietariosRoutes');
const medidasBateriasRoutes = require('./src/routes/medidasBateriasRoutes');
...
const tipoUnidadMovilRoutes = require('./src/routes/tipoUnidadMovilRoutes');
...
app.use('/medidas_baterias', medidasBateriasRoutes);
...
app.use('/tipo_unidad_movil', tipoUnidadMovilRoutes);
